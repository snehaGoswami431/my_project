...
<br/>
  ...
  <div class="panel panel-default" style="width:500px;margin: auto;">
   ...
   <div class="panel-body">
    <form method="post" action="<?php echo base_url(); ?>Login/update_product">
      <div class="form-group">
      <label>Enter Product Name</label>
      <input type="text" name="name" class="form-control" value="<?=set_value('name',$value[0]['name']);?>" />
      <span class="text-danger"><?php echo form_error('name'); ?></span>
     </div>
     <div class="form-group">
      <label>Enter Product Price</label>
      <input type="number" name="price" class="form-control" value="<?=set_value('price',$value[0]['price']);?>" />
      <span class="text-danger"><?php echo form_error('price'); ?></span>
     </div>
  
     <div class="form-group">
      <label>Enter Product Description</label>
      <input type="text" name="description" class="form-control" value="<?=set_value('description',$value[0]['description']);?>" />
      <span class="text-danger"><?php echo form_error('description');?></span>
     </div>
     <div class="form-group" style="">
      
      <input type="hidden" name="add_by_user" class="form-control" value="<?=set_value('add_by_user',$value[0]['add_by_user']); ?>">
     
     
     </div>
 <input type="hidden" name="id" class="form-control" value="<?=set_value('id',$value[0]['ID']); ?>">
     <div class="form-group">
